    ...
    */
    ...
    public static void main(String[] args) {
        ...
        PlotWindow.launch("Experiment 6", "Input Size [n]", "Elapsed Time (ms)",
                new LongUnaryOperator[]{Experiment6MasterTheorem::test3, Experiment6MasterTheorem::test2},
                new String[]{"test3", "test2"}, inputSizes, 2, .05);

        System.out.println("All done!");
    }

    public static long test3(long inputSize) {
